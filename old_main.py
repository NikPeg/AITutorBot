...
file = client.files.create(file=open("Задание информатика.docx", "rb"), purpose="assistants")
...
my_run = client.beta.threads.runs.create(
    thread_id=my_thread.id, assistant_id=my_assistant.id, instructions="Please address the user as Rok Benko."
)
